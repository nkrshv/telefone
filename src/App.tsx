...
function securityBadge(e2ee: boolean | null): {
  ...
  return {
    ...
    title:
      'Звонок зашифрован (DTLS-SRTP). Дополнительный сквозной слой недоступен — его не поддерживает браузер собеседника.',
  };
}
      ...
      text:
        e2ee === true
          ...
          : e2ee === null
            ...
            : 'Недоступно: браузер собеседника не поддерживает эту функцию. Звонок всё равно зашифрован (DTLS-SRTP).',
    },
  ];
