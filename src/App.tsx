...
function securityBadge(e2ee: boolean | null): {
  ...
  return {
    ...
    title:
      'Звонок защищён сквозным шифрованием (DTLS-SRTP). Видео идёт напрямую между вашими устройствами. Усиленный режим (доп. слой AES-256-GCM) включается, когда оба собеседника в Chrome.',
  };
}
      ...
      text:
        e2ee === true
          ...
          : e2ee === null
            ...
            : 'Усиленный режим: включается автоматически, когда оба собеседника в Chrome. Сейчас звонок защищён сквозным шифрованием (DTLS-SRTP).',
    },
  ];
  ...
  return (
    <div className="sec-backdrop" onClick={onClose}>
      ...
      >
        ...
        <div className={`sec-hero ${e2ee === null ? 'pending' : 'ok'}`}>
